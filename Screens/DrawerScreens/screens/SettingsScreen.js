				...
				<ScrollView contentContainerStyle={{ flex: 1, paddingVertical: 30 }} >
					...
					<View style={[styles.container, { alignItems: 'center' }]} >
						...
						<View style={{ marginVertical: 20 }} >
							<Text style={{ fontWeight: 'bold', fontSize: 20, textAlign: 'center' }} >{this.state.userName}</Text>
							<Text style={{ fontWeight: '200', fontSize: 16, textAlign: 'center' }} >{this.state.userMobile}</Text>
						</View>
					</View>
